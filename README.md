...
**The "blockwalk.py" and "blockwalk2.py" were developed for simulating macroscopic ion conduction of solid electrolyte compacts.** These programs simulate how a ion moves within a block-type percolation model and calculate the curvature of its pathway. I anticipate that this program could be applied not only to ion conductors but also to various conduction models in other fields.  
